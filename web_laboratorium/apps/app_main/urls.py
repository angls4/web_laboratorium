...
urlpatterns = [
    ...
    path("api/pendaftaran/", api.get_pendafataran, name="api_get_pendaftaran"),
    ...
    path("api/pendaftaran/set-nilai/<int:id>", api.set_nilai, name="api_set_nilai"),
    ...
    path("api/asisten/pdf", api.asisten_pdf, name="asisten_pdf"),
